...
public sealed class ClarificationRequest
{
    ...
    public EntityId Id { get; } public string Field { get; } public DateTimeOffset ExpiresAtUtc { get; } public ClarificationStatus Status { get; private set; } = ClarificationStatus.Created;
