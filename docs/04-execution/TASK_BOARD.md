...
| P00-T04 | Chốt coding conventions | 00 | Should | DONE | P00-T07 | `CODING_CONVENTIONS.md`; format PASS; Release analyzer build 0 warning/error; tests 2/2 PASS |
...
| P00-T08 | Thiết lập config validation và secret-safe baseline | 00 | Must | READY | P00-T01, P00-T07 | Startup/config tests + secret scan |
